// Package sendpool — استخر sender با چند worker
// از transport.Transport interface استفاده میکنه — هم UDP هم Obfs
package sendpool
...
type Config struct {
	Workers   int
	QueueSize int
	Transport transport.Transport // یه transport مشترک
}
